 ...
 *         Date: 01.05.2009
 */
public class UpdateAllOutputsOptionParser implements OptionParser {
    ...
    public List<Command> parse(final CommandLine _commandLine, final ApiFacade _api, final Map<String, String> _context) {
        ...
        List<String> masks = OptionParserUtils.getOptionsList(_commandLine, UPDATE_ALL_OUTPUTS_OPTION_SHORT_NAME);
