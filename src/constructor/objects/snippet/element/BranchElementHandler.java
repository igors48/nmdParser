...
/**
 * Обработчик элемента snippet.branch в XML файле
 *
 * @author Igor Usenko
 *         Date: 11.12.2009
 */
public class BranchElementHandler extends AbstractElementHandler {
    ...
    protected void handleAttribute(final Node _node, final Object _blank, final ConstructorFactory _factory) throws AttributeHandler.AttributeHandlerException {
        ...
        if (name.equals(NAME_KEY)) {
            ((SnippetConfiguration) _blank).setBranch(value);
        }
    }
}