...
/**
 * Обработчик элемента snippet.noRemoveExists в XML файле
 *
 * @author Igor Usenko
 *         Date: 09.12.2009
 */
public class NoRemoveExistsElementHandler implements ElementHandler {
    ...
    public void handle(final Element _element, final Object _blank, final ConstructorFactory _factory) throws ElementHandlerException {
        ...
        ((SnippetConfiguration) _blank).setRemoveExists(false);
    }
}