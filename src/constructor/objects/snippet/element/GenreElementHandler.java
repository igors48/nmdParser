...
/**
 * Обработчик элемента snippet.genre в XML файле
 *
 * @author Igor Usenko
 *         Date: 12.12.2009
 */
public class GenreElementHandler extends AbstractElementHandler {
    ...
    protected void handleElement(final Node _node, final Object _blank, final ConstructorFactory _factory) throws ElementHandlerException {
        ...
        ((SnippetConfiguration) _blank).addGenre(value);
    }
