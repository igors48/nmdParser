...
/**
 * Обработчик атрибута output.linksAsFootnotes
 *
 * @author Igor Usenko
 *         Date: 06.04.2009
 */
public class LinksAsFootnotesAttributeHandler implements AttributeHandler {
    ...
    public void handle(String _id, String _value, Object _blank, ConstructorFactory _factory) throws AttributeHandlerException {
        ...
        ((OutputConfiguration) _blank).setLinksAsFootnotes(_value);
    }
}