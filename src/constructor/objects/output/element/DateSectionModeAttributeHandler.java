...
/**
 * Обработчик атрибута output.research.channeldataprocessor.channel
 *
 * @author Igor Usenko
 *         Date: 06.04.2009
 */
public class DateSectionModeAttributeHandler implements AttributeHandler {
    ...
    public void handle(String _id, String _value, Object _blank, ConstructorFactory _factory) throws AttributeHandlerException {
        ...
        ((OutputConfiguration) _blank).setDateSectionMode(_value);
    }
}