...
import constructor.objects.dateparser.core.LessThanMinuteStrategy;
import org.w3c.dom.Node;
import util.Assert;

/**
 * Обработчик элемента dateParser.lessThanMinute
 *
 * @author Igor Usenko
 *         Date: 13.06.2009
 */
public class LessThanMinuteElementHandler extends AbstractElementHandler {
    ...
    protected void handleElement(final Node _node, final Object _blank, final ConstructorFactory _factory) throws ElementHandlerException {
        ...
        ((DateParserConfiguration) _blank).addStrategy(value, new LessThanMinuteStrategy());
    }
