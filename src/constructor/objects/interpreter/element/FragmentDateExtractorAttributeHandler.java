...
/**
 * Обработчик атрибута interpreter.fragment.dateExtractor
 *
 * @author Igor Usenko
 *         Date: 27.03.2009
 */
public class FragmentDateExtractorAttributeHandler implements AttributeHandler {
    ...
    public void handle(String _id, String _value, Object _blank, ConstructorFactory _factory) throws AttributeHandlerException {
        ...
        try {
            ...
            if (!_id.equals(DEFAULT_KEY)) {
                ...
                ((FragmentAnalyserConfiguration) _blank).setDateProcessor(processor);
            }
