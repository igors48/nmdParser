...
/**
 * Обработчик атрибута interpreter.fragment.title
 *
 * @author Igor Usenko
 *         Date: 27.03.2009
 */
public class FragmentTitleAttributeHandler implements AttributeHandler {
    ...
    public void handle(String _id, String _value, Object _blank, ConstructorFactory _factory) throws AttributeHandlerException {
        ...
        try {
            ...
            if (!_id.equals(DEFAULT_KEY)) {
                ...
                ((FragmentAnalyserConfiguration) _blank).setTitleProcessor(processor);
            }
